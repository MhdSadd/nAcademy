...
const { create_course, profile, all_instructors, allCourseGet, delete_instructor, approve_instructor, delete_course, update_courseGet, update_coursePost, updateCourse, approved_instructors, profile_update } = require("../../controllers/admin/adminController");
